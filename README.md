...
- VehicleController.cs - Vehicle driving and weapons
- Enemy.cs - Enemy AI with 6 types
- GameManager.cs - Game state and wave system
- UIManager.cs - Complete HUD system
...
- RocketProjectile.cs - Rocket projectiles
- Mine.cs - Mine system
- PostProcessingSetup.cs - Post-processing setup
...
- [GitHub Repository](https://github.com/YOURUSERNAME/UltimateHybridGame)

---

**Made with passion. Built in public.**